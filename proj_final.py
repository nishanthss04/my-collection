...
label=Label(text="CMR STUDENT MANAGEMENT SYSTEM",font=("times new roman",35),bg="green",fg="white")
...
def second():
    ...
    def studentid():
        ...
        mainlabel = Label(rot, text="STUDENT DETAILS", font=("times new roman", 35), bg="green",fg="white")
        ...
        ttk.Style().configure("Treeview", background="green", foreground="coral1")
    ...
    def viewenquiry2():
        ...
        mainlabel =Label(rt, text="VISITOR", font=("times new roman", 35), bg="green",fg="white")
        mainlabel.pack(side=TOP, fill=X)
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="CMR STUDENT MANAGEMENT SYSTEM", font=("times new roman", 35), bg="green",fg="white")
    mainlabel.pack(side=TOP, fill=X)
    button = Button(secondw,width=15, font=("arial", 20), text="REGISTRATION", bg="green",fg="white", command=distroy4)
    button.place(x=10, y=480)
    enquiry = Button(secondw, width=15, font=("arial", 20), text="FEE DETAILS", bg="green",fg="white",command=distroy5)
    enquiry.place(x=280, y=480)
    fee_details = Button(secondw, width=15, font=("arial", 20), text="ENQUIRY", bg="green",fg="white",command=enquiry1)
    fee_details.place(x=560, y=480)
    viewenquiry= Button(secondw, width=15, font=("arial", 20), text="VIEW ENQUIRY", bg="green",fg="white",command=viewenquiry2)
    viewenquiry.place(x=840, y=480)
    viewenquiry1 = Button(secondw, width=15, font=("arial", 20), text="STUDENT DETAILS", bg="green",fg="white",command=studentid)
...
def login():
    if user.get()=="admin" and user3.get()=="cmrnps":
        second()
        distroy()
...
def root():
    ...
    calculation2 = 2000
    label=Label(root,text="REGISTRATION FORM", font=("arial",25), bg="green",fg="white")
    label.pack(side=TOP, fill=X)
    ...
    label4=Label(root,text="SECTION", font=("arial",17))
    ...
    box['values']=['SELECT','COMPUTER SCIENCE','BIOLOGY','COMMERCE','HUMANITIES']
    box.current(0)
    box.place(x=503,y=395)
    
    checkbutton1=Checkbutton(root,text="A",variable=java)
    checkbutton1.place(x=502,y=455 )

    checkbutton1=Checkbutton(root,text="B",variable=c)
    checkbutton1.place(x=555,y=455 )

    checkbutton1=Checkbutton(root,text="C",variable=d)
    checkbutton1.place(x=600,y=455 ,)
	 
    checkbutton1=Checkbutton(root,text="D",variable=python)
    ...
    button1=Button(root,text="CALCULATE FEE",width=14,font=("arial",10),bg="green",fg="white" ,command=calculation)
    button1.place(x=530 , y=630)

    button12 = Button(root, text="BACK", width=17, font=("arial", 17), bg="red",fg="green",command=dis )
    button12.place(x=0, y=0)

    button2=Button(root,text="SUBMIT FORM",width=14,font=("arial",10),bg="green",fg="white",command= msg  )
    button2.place(x=660 , y=630)

    button3=Button(root,text="RESET",width=14,font=("arial",10),bg="green",fg="white",command= golu )
    button3.place(x=395 , y=630)
    
    button4=Button(root,text="UPDATE",width=14,font=("arial",10),bg="green",fg="white" ,command=update)
    button4.place(x=950 , y=630)

    button5=Button(root,text="DELETE",width=14,font=("arial",10),bg="green",fg="white",command=delete )
...
def enquiry1():
    ...
    def enquiry1destroy():
        enquiry1.destroy()
        second()
    label22 = Label(enquiry1, text="ENQUIRY", font=("arial", 25), bg="green",fg="white")
    ...
    button = Button(enquiry1, text="submit", width=30, bg="green",fg="white", command=r)
    button.place(x=500, y=320)
    button1=Button(enquiry1, text="<< BACK", width=30, bg="red",fg="green",command=enquiry1destroy)
    ...
    box2['values'] = ['SELECT', 'TO MEAT CLASS TEACHER', 'GRADES', 'FEE DETAILS','SCHOOL BUS DETAILS']
    box2.current(0)
    box2.current(0)
...
def window():
  ...
  button = Button(main, text="BACK", width=30, bg="red",fg="green", command=distroy3)
  ...
  button22=Button(main,text="LOGIN",width=26,font=("arial",10),bg="green",fg="white",command=cat )
  button22.place(x=400, y=310)
  button23=Button(main,text="ADD FEE",width=26,font=("arial",10),bg="green",fg="white",command=installment2 )
  button23.place(x=650 , y=310)
  entry29=Entry(main,bd=5, width=20 ,font=("arial",15))
  entry29.place(x=650,y=200)
  button28 = Button(main, text="RESET", width=26, font=("arial", 10), bg="red",fg="green", command=reset2)
...
def calculation():
 ...
 if NAME==("") and  SUR==("")and  EMAIL==("") and BOX==("SELECT") and  GANDER==(3) and  JAVA==(0) and  PYTHON==(0) and C==(0) and  D==(0):
     ...
     if box.get()=="COMPUTER SCIENCE" and gander.get()==1:
         ...
         entry5.insert(0, x)
         entry5.configure(state="disable")
     if box.get()=="BIOLOGY" and gander.get()==1:
         x=120000
         entry5.configure(state="normal")
         entry5.delete(0, END)
         entry5.insert(0, x)
         entry5.configure(state="disable")
     if box.get()=="BIOLOGY" and gander.get()==0:
         x=120000
         entry5.configure(state="normal")
         entry5.delete(0, END)
         entry5.insert(0, x)
         entry5.configure(state="disable")
     if box.get()=="COMMERCE" and gander.get()==0:
         x=120000
         entry5.configure(state="normal")
         entry5.delete(0, END)
         entry5.insert(0, x)
     ...
     if box.get()=="HUMANITIES" and gander.get()==1:
         x=120000
         entry5.configure(state="normal")
         entry5.delete(0, END)
         entry5.insert(0, x)
         entry5.configure(state="disable")
     if box.get()=="HUMANITIES" and gander.get()==0:
...
INQUIRY=Button(text="LOGIN",width=17,font=("arial",20),bg="green",fg="white",command=login )
